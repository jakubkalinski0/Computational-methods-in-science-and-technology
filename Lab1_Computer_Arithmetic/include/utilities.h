...
#include <math.h> // Choć nie jest tu bezpośrednio potrzebny, może być dla definicji typów

// --- Zaktualizowane sygnatury funkcji ---
// Wszystkie funkcje generujące pliki teraz przyjmują odpowiednie ścieżki
